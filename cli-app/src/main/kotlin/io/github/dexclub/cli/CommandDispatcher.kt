...
internal class CommandDispatcher(
    ...
    fun dispatch(request: CliRequest): CommandResult =
        when (request) {
            ...
            is CliRequest.Refresh -> workspace.refresh(request)
            ...
            is CliRequest.GetResValue -> resource.getResValue(request)
            is CliRequest.FindResValues -> resource.findResValues(request)
            ...
            is CliRequest.ExportMethodJava -> export.exportMethodJava(request)
        }
}
