...
internal class Renderer {
    ...
    private fun renderText(payload: RenderPayload): String =
        when (payload) {
            ...
            is RenderPayload.Manifest -> renderTextArtifact(payload.view)
            is RenderPayload.ResourceTable -> renderResourceTable(payload.view)
            is RenderPayload.DecodedXml -> renderTextArtifact(payload.view)
    ...
    private fun renderTextArtifact(view: TextArtifactView): String = view.text
