        ...
        SelectionHandle(
            ...
            onDragViewportPosition = { viewportPosition ->
                val draggedTextOffset = resolveTextOffsetFromViewportPosition(
                    ...
                    contentStartPaddingPx = viewportSnapshot.contentStartPaddingPx,
                    contentLeftInsetPx = viewportSnapshot.contentLeftInsetPx,
...
internal fun resolveTextOffsetFromViewportPosition(
    ...
    return resolveEditorTextOffset(
        ...
        position = Offset(
            x = (viewportPosition.x - contentLeftInsetPx) + horizontalScrollPx,
