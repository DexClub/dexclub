...
val grammarDir = project.layout.projectDirectory.dir("../tree-sitter-kotlin").asFile
val sourceDir = project.layout.projectDirectory.dir("../tree-sitter-kotlin/src").asFile
...
val jniLibBaseName = "ktreesitter-kotlin"
...
grammar {
    ...
    packageName = "io.github.dexclub.treesitter.kotlin"
    files = arrayOf(
...
kotlin {
    jvm()
    android {
        namespace = "io.github.dexclub.treesitter.kotlin"
        compileSdk = 36
        minSdk = 24
    }
