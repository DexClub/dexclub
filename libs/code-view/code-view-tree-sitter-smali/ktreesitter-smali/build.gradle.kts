...
val grammarDir = project.layout.projectDirectory.dir("../tree-sitter-smali").asFile
val sourceDir = project.layout.projectDirectory.dir("../tree-sitter-smali/src").asFile
...
val jniLibBaseName = "ktreesitter-smali"
...
grammar {
    baseDir = grammarDir
    grammarName = "smali"
    className = "TreeSitterSmali"
    packageName = "io.github.dexclub.treesitter.smali"
    files = arrayOf(
        sourceDir.resolve("parser.c"),
        sourceDir.resolve("scanner.c"),
    )
}
...
kotlin {
    jvm()
    android {
        namespace = "io.github.dexclub.treesitter.smali"
        compileSdk = 36
        minSdk = 24
    }
