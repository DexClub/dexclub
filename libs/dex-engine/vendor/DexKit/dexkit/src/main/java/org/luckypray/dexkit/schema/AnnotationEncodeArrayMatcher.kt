...
internal class `-AnnotationEncodeArrayMatcher` : Table() {
    ...
    fun values(j: Int) : `-AnnotationEncodeValueMatcherWrapper`? = values(`-AnnotationEncodeValueMatcherWrapper`(), j)
    fun values(obj: `-AnnotationEncodeValueMatcherWrapper`, j: Int) : `-AnnotationEncodeValueMatcherWrapper`? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun createAnnotationEncodeArrayMatcher(builder: FlatBufferBuilder, valuesOffset: Int, matchType: Byte, valueCountOffset: Int) : Int {
        ...
        fun addValueCount(builder: FlatBufferBuilder, valueCount: Int) = builder.addOffset(2, valueCount, 0)
