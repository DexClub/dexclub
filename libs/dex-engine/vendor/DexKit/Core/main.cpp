                                                    ...
                                                    fbb.CreateVector(std::vector<flatbuffers::Offset<AnnotationElementMatcher>>{
                                                            CreateAnnotationElementMatcher(
                                                                    ...
                                                                    /* CreateAnnotationEncodeArrayMatcher(
                                                                     ...
                                                                     CreateAnnotationEncodeArrayMatcher(
                                                                            fbb,
                                                                            fbb.CreateVector(std::vector<flatbuffers::Offset<AnnotationEncodeValueMatcherWrapper>>{
                                                                                CreateAnnotationEncodeValueMatcherWrapper(
                                                                                    fbb, 
                                                                                    AnnotationEncodeValueMatcher::ClassMatcher,
                                                                                    CreateClassMatcher(
                                                                                        fbb,
...
int DexKitFindMethodUsingNumbers(dexkit::DexKit &dexkit) {
    ...
    auto find = CreateFindMethod(
            ...
            CreateMethodMatcher(
                    ...
                    fbb.CreateVector(std::vector<flatbuffers::Offset<NumberWrapper>>{
                        CreateNumberWrapper(fbb, Number::EncodeValueInt, CreateEncodeValueInt(fbb, 0).Union()),
                        CreateNumberWrapper(fbb, Number::EncodeValueLong, CreateEncodeValueLong(fbb, -1).Union()),
                        CreateNumberWrapper(fbb, Number::EncodeValueFloat, CreateEncodeValueFloat(fbb, 0.01).Union()),
                        CreateNumberWrapper(fbb, Number::EncodeValueDouble, CreateEncodeValueDouble(fbb, 0.987f).Union()),
                        CreateNumberWrapper(fbb, Number::EncodeValueLong, CreateEncodeValueLong(fbb, 114514).Union())
                    })
            )
    );
    fbb.Finish(find);
