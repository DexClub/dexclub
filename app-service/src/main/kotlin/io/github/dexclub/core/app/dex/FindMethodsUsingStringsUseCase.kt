...
data class FindMethodsUsingStringsUseCaseRequest(
...
data class FindMethodsUsingStringsUseCaseResult(
...
class FindMethodsUsingStringsUseCase(
    ...
    fun execute(request: FindMethodsUsingStringsUseCaseRequest): FindMethodsUsingStringsUseCaseResult {
        ...
        val anyHits = if (request.containsAnyStrings.isNotEmpty()) {
            dexService.findMethodsUsingStrings(
        ...
        return FindMethodsUsingStringsUseCaseResult(
