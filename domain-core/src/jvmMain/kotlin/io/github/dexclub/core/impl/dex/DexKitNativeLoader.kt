...
internal object DexKitNativeLoader {
    ...
    private fun loadLibrary() {
        ...
        if (libraryFile == null) {
            ...
            throw UnsatisfiedLinkError(
                "Unable to load DexKit native library: $LIBRARY_NAME; searched=$searchedText; " +
                    "call System.load(...) first, or configure ${DexKitNative.LIBRARY_DIR_PROPERTY} / java.library.path"
            )
        }
    ...
    private fun findDirsByWorkingDirectory(): List<File> {
        ...
        repeat(6) {
            ...
            result += File(current, "dexkit-binding/vendor/DexKit/dexkit/build/library")
