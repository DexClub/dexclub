...
import org.luckypray.dexkit.InnerNumberWrapper
...
class MethodMatcher : BaseQuery, IAnnotationEncodeValue {
    ...
    override fun innerBuild(fbb: FlatBufferBuilder): Int {
        ...
        // wrapper for number type and value
        val numberWrapper = usingNumbersMatcher?.map {
            InnerNumberWrapper.createNumberWrapper(
                fbb,
                it.type!!.value,
