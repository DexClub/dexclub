...
class CliAppFailureRenderingTest {
    ...
    fun unexpectedFailureIncludesDebugHintOrStackTraceWhenEnabled() {
        val baseServices = createDefaultServices()
        ...
        val plainApp = CliApp(
            ...
            cwdProvider = { createTempDirectory("dexclub-cli-unexpected").toString() },
        ...
        val debugApp = CliApp(
            services = failingServices,
            cwdProvider = { createTempDirectory("dexclub-cli-unexpected-debug").toString() },
