...
val IconRes.MixedInterfaceClass: ImageVector
    get() {
        if (_MixedInterfaceClass != null) {
            return _MixedInterfaceClass!!
        }

        _MixedInterfaceClass = ImageVector.Builder(
            name = "MixedInterfaceClass",
            defaultWidth = 16.dp,
            defaultHeight = 16.dp,
            viewportWidth = 16f,
            viewportHeight = 16f,
...
private var _MixedInterfaceClass: ImageVector? = null
